    ...
    <div class="max-w-md mx-auto bg-white pb-16"> 
        ...
        <div class="px-2 py-4">
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    <p class="font-serif font-medium text-[#4871AD] text-lg">{{ Auth::guard('seller')->user()->shop_name }}</p>
                ...
                <a href="#" class="ml-auto text-[#4871AD] hover:text-[#7EA3E4] transition-colors duration-300 hover:scale-110 transform inline-block">
        ...
        <div class="px-2 mb-4">
            <div class="border border-[#4871AD] rounded-lg p-3">
                ...
                <div class="grid grid-cols-3 gap-2 text-center">
                    <div class="bg-[#4871AD] text-white rounded-md p-2 transition-all duration-300 hover:bg-[#5A83BF] hover:scale-105 hover:shadow-md cursor-pointer">
            ...
            <div class="border border-[#4871AD] p-2">
                ...
                <div class="grid grid-cols-2 gap-2">
                    @forelse ($products as $product)
                        <a href="{{ route('seller.products.edit', $product) }}" class="block transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
                            <div class="border border-[#4871AD] rounded-lg overflow-hidden">
                                ...
                                <div class="p-1.5">
                                    <p class="text-xs font-medium font-serif text-[#4871AD] truncate">{{ $product->name }}</p>
                                    <p class="text-xs font-serif text-gray-600">Rp{{ number_format($product->price, 0, ',', '.') }}</p>
                                </div>
                            </div>
                        </a>
                    @empty
