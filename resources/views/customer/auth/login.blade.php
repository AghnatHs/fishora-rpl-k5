<x-app-layout>
    ...
    <div class="min-h-screen flex flex-col items-center justify-start pt-35 w-full max-w-md mx-auto">
        <h2 class="text-3xl font-medium text-center mb-8" style="color: #4871AD; font-family: 'DM Serif Text', serif;">Masuk sebagai Pembeli</h2>

        @include('components.modals.status')
        @include('components.modals.errors')

        <form method="POST" action="{{ route('customer.login') }}" class="space-y-6 w-full">
            @csrf
            ...
            <div>
                ...
                <div class="mt-2 text-right">
                    <a href="{{ route('customer.password.request') }}" class="text-lg font-medium text-[#4871AD] hover:text-[#ABCDFF] transition-colors duration-200" style="font-family: 'DM Serif Text', serif;">Lupa Kata Sandi?</a>
                </div>
            </div>
        ...
        <p class="mt-20 text-center text-gray-400 text-lg" style="font-family: 'DM Serif Text', serif;">
            ...
            <a href="{{ route('customer.register') }}" class="font-medium text-[#4871AD] hover:text-[#ABCDFF] transition-colors duration-200" style="font-family: 'DM Serif Text', serif;">Daftar</a>
        </p>
    </div>
</x-app-layout>
