<x-app-layout>
    ...
    <div class="min-h-screen flex flex-col items-center justify-start pt-48 w-full max-w-md mx-auto">
        <h2 class="text-3xl font-medium text-center mb-8" style="color: #4871AD; font-family: 'DM Serif Text', serif;">Masuk sebagai Admin</h2>

        @include('components.modals.status')
        @include('components.modals.errors')

        <form method="POST" action="{{ route('admin.login') }}" class="space-y-6 w-full">
            @csrf
